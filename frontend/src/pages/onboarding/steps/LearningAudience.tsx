...
export const LearningAudience: React.FC<StepProps> = ({ onNext, onSkip, progress }) => {
  return (
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-12 text-center">
          <div className="mb-8">
            <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-blue-100 mb-6">
              <UsersIcon className="w-12 h-12 text-blue-600 animate-pulse" />
            </div>
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              Learning About Your Target Audience
            </h1>
            <p className="text-lg text-gray-600">
              Understanding who you want to reach and engage with
            </p>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4 text-left">
                ...
                <p className="text-sm text-blue-800 mt-1">
                  Repurposing content across platforms can maximize your reach.
                  Adapt your LinkedIn posts for Twitter, Instagram, or your blog to engage audiences on multiple channels.
                </p>
              </div>
            </div>
          </div>
