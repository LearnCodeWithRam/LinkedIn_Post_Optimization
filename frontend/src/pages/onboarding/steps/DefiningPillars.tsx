...
export const DefiningPillars: React.FC<StepProps> = ({ onNext, onSkip, progress }) => {
  return (
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-12 text-center">
          <div className="mb-8">
            <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-[#0d569e]/10 mb-6">
              <RectangleStackIcon className="w-12 h-12 text-[#0d569e] animate-pulse" />
            </div>
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              Defining Your Content Pillars
            </h1>
            <p className="text-lg text-gray-600">
              Establishing the core themes for your content strategy
            </p>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4 text-left">
                ...
                <p className="text-sm text-gray-800 mt-1">
                  Content pillars help you stay focused and consistent.
                  Choose 3-5 core topics that align with your expertise and audience interests to build authority in your niche.
                </p>
              </div>
            </div>
          </div>
