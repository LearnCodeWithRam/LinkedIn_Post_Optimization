...
export const DesigningStrategy: React.FC<StepProps> = ({ onNext, onSkip, progress }) => {
  return (
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-12 text-center">
          <div className="mb-8">
            <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-[#0d569e]/10 mb-6">
              <ChartBarIcon className="w-12 h-12 text-[#0d569e] animate-pulse" />
            </div>
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              Designing Your Content Strategy
            </h1>
            <p className="text-lg text-gray-600">
              Creating a personalized plan for your LinkedIn success
            </p>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4 text-left">
                ...
                <p className="text-sm text-gray-800 mt-1">
                  Analyzing your post performance helps refine your content strategy.
                  Track metrics like engagement rate, reach, and click-through rates to understand what resonates with your audience.
                </p>
              </div>
            </div>
          </div>
